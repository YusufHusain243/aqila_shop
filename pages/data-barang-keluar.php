...
$data_barang_keluar = show_data("SELECT * FROM barang_keluar INNER JOIN barang ON barang_keluar.id_barang = barang.id_barang");
?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/?page=data-barang&action=tambah" method="post">
                    <div class="mb-3">
